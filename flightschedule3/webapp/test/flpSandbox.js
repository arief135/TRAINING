		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mikasapflightschedule3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mikasapflightschedule3-display": {
								"semanticObject": "mikasapflightschedule3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mika.sap.flightschedule3",
									"url": sap.ui.require.toUrl("mika/sap/flightschedule3")
								}
							}
						}
					}
