sap.ui.define([
    ...
    return BaseController.extend("mika.sap.flightschedule3.controller.List", {
        ...
        onInit: function () {
            ...
            this._oGroupFunctions = {
                Distance: function (oContext) {
                    var iNumber = oContext.getProperty('Distance'),
                        key, text;
                    if (iNumber <= 20) {
                        key = "LE20";
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Connid", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "mika.sap.flightschedule3.view.ViewSettingsDialog",
                    controller: this
        ...
        onConfirmViewSettingsDialog: function (oEvent) {
            ...
            aFilterItems.forEach(function (oItem) {
                switch (oItem.getKey()) {
                    case "Filter1":
                        aFilters.push(new Filter("Distance", FilterOperator.LE, 100));
                        break;
                    case "Filter2":
                        aFilters.push(new Filter("Distance", FilterOperator.GT, 100));
                        break;
                    default:
                        break;
                }
